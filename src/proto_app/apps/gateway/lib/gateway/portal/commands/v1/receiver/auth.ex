defmodule Gateway.Portal.Commands.V1.Receiver.Auth do
  ...
  get "/refresh" do
    case getHeaderValue(conn, "refresh-token") do
      ...
      token ->
        case Gateway.Portal.Commands.Handler.Auth.refresh(token) do
          {:ok, meta} ->
            jsonRsp(conn, 200, %{ok: meta})
  ...
  post "/register" do
    case conn.body_params do
      ...
      params ->
        case Gateway.Portal.Commands.Handler.Auth.register(params) do
          {:ok, data} ->
  ...
  post "/logout" do
    case getHeaderValue(conn, "access-token") do
      ...
      token ->
        case Gateway.Portal.Commands.Handler.Auth.logout(token) do
          {:ok, meta} ->
            jsonRsp(conn, 200, %{ok: meta})
    ...
    case conn.body_params do
      ...
      params ->
        ...
        if nil == user do
          ...
          case Gateway.Portal.Commands.Handler.Auth.resetPassword(user) do
            {:ok, data} ->
              jsonRsp(conn, 201, %{ok: data})
    ...
    case conn.body_params do
      ...
      params ->
        ...
        if nil == id or nil == pass or nil == conf do
          ...
          case Gateway.Portal.Commands.Handler.Auth.changePassword(id, pass, conf) do
            {:ok, data} ->
              jsonRsp(conn, 201, %{ok: data})
    ...
    case conn.body_params do
      ...
      params ->
        ...
        if nil == email do
          ...
          case Gateway.Portal.Commands.Handler.Auth.forgotUsername(email) do
            {:ok, data} ->
              jsonRsp(conn, 200, %{ok: data})
